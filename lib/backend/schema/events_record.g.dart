    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'geoCode':
          ...
          break;
        case 'occuredAt':
          result.occuredAt = serializers.deserialize(value,
...
class _$EventsRecord extends EventsRecord {
  ...
  _$EventsRecord._(
      {this.description, this.userId, this.geoCode, this.occuredAt, this.ffRef})
      : super._();
  ...
  int get hashCode {
    return $jf($jc(
        $jc(
            $jc($jc($jc(0, description.hashCode), userId.hashCode),
                geoCode.hashCode),
            occuredAt.hashCode),
        ffRef.hashCode));
  }
...
class EventsRecordBuilder
  ...
  DateTime? _occuredAt;
  DateTime? get occuredAt => _$this._occuredAt;
  set occuredAt(DateTime? occuredAt) => _$this._occuredAt = occuredAt;
